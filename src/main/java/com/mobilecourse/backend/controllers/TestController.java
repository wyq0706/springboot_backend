...
public class TestController extends CommonController {
    ...
    public String hello() {
        return wrapperMsg("当前数据库中共有：" + testMapper.testCnt() + "条数据！","");
    }
    ...
    public String delete(@PathVariable int id) {
        ...
        return wrapperMsg("成功删除id为：" + id + "的数据！","");
    }
    ...
    public String upload(@RequestParam(value = "file")MultipartFile file) {
        return wrapperMsg(file.getOriginalFilename(),"");
    }
    ...
    public String selectAll() {
        try {
            ...
            return wrapperMsg(jsonArray.toJSONString(),"");
        } catch (Exception e) {
            return wrapperMsg(e.toString(),"");
        }
    }
